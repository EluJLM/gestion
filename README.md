...
Este proyecto incluye `Dockerfile` + `docker-compose.yml` para que el flujo en servidor sea:
...
> Si cambias dependencias de sistema (por ejemplo extensiones PHP o versión de Node), usa:
>
> ```bash
> docker compose up -d --build
> ```
